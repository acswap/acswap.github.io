    ...
    67165: (e, t, n) => {
      ...
      function ko(e) {
        return new so.TranslatedString(
          e.name(),
          e.title(vo.TitleDisplayTarget.DataWindow),
        );
      }
      const Mo = new Xn.Delegate();
      class Do {
        constructor(e, t) {
        ...
        title() {
          ...
          return (0, lo.isLineTool)(e)
            ...
            : (0, uo.isSeries)(e) && this._undoModel.mainSeries() === e
              ? e.symbolTitle(
                  vo.TitleDisplayTarget.DataWindow,
                  void 0,
                  void 0,
        ...
        setVisible(e) {
          const t = (e ? bo : yo).format({ title: ko(this._dataSource) });
        ...
        doNotAffectChartInvalidation() {
          return (0, lo.isLineTool)(this._dataSource) && To;
        }
      ...
      var Lo = n(80842),
        ...
        Fo = n(33055),
        Wo = n(35149);
      const Ho = (0, l.getLogger)("Platform.GUI.ObjectTree");
      const Vo = new so.TranslatedString(
          "move objects",
      ...
      class $o {
        constructor(e) {
          (this._nodes = {}),
            ...
            (this._isContextMenuOpened = new Ro.WatchedValue(!1)),
            ...
            (this._init = () => {
              ...
              e.hasModel() &&
                ...
                (this._groupModel = this._model.lineToolsGroupModel()),
                (this._facade = new xo(this._controller)),
                (this._subscriptions = [
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          1 === this._objects.length &&
            r.unshift(this._getRenameAction(t), new jo.Separator()),
            n && r.unshift(this._getGroupAction(), new jo.Separator());
          const i = (0, ho.createSyncDrawingActions)(
            this._chart.value(),
            o.filter(lo.isLineTool),
          );
          i.length && (i.shift(), i.push(new jo.Separator()), r.push(...i));
