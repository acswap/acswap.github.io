    ...
    50366: (e, t, a) => {
      ...
      function h(e) {
        ...
        return i.createElement(
          ...
          n && i.createElement(s.Icon, { className: c.icon, icon: g }),
          !p &&
            i.createElement(
              "span",
              { className: l()(c.title, !n && c.withoutIcon) },
              i.createElement("span", { className: c.titleText }, a),
              u && i.createElement(s.Icon, { className: c.nested, icon: o }),
            ),
        );
      }
    },
    72811: (e, t, a) => {
      ...
      function I(e) {
        const {
          ...
          c = n.useCallback(() => {
            (0, k.loadTheme)(a, { themeName: t, standardTheme: !1 }).then(
              () => {
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleApplyDefaults = () => {
              ...
              const a = (0, k.getCurrentTheme)().name;
              (0, k.loadTheme)(t, {
                themeName: a,
                standardTheme: !0,
                applyOverrides: !0,
          ...
          return n.createElement(
            ...
            l.length > 0 &&
              n.createElement(
                n.Fragment,
                null,
                n.createElement(y.PopupMenuSeparator, { key: "separator" }),
                l.map((e) =>
                  n.createElement(I, {
                    key: e,
                    themeName: e,
      ...
      var Z = a(76422),
        Q = a(85067),
        J = a(37591);
      const $ = i.t(null, void 0, a(74207));
      class ee extends Q.DialogRenderer {
        constructor(e) {
          super(),
            (this._handleClose = () => {
          ...
          l.render(
            ...
            Z.emit("edit_object_dialog", {
              ...
              scriptTitle: this._model
                .mainSeries()
                .title(J.TitleDisplayTarget.StatusLine),
            });
        }
        _ensureCheckpoint(e) {
